...
public class OOExemplosAula2020 {
    ...
    // e feita a comparacao de quem é o mais velho
     static void antigo (CarroAula2020 um, CarroAula2020 dois){
         if (um.ano < dois.ano){
    ...
    public static void main(String[] args) {
        ...
        CarroAula2020 carro1 = new CarroAula2020();
        carro1.ano = 1996;
        carro1.marca = "BMW";
        ...
        // e sua inicializacao de valores
        CarroAula2020 carro2 = new CarroAula2020();
        carro2.ano = 2019;
